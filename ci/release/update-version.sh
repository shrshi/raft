...
sed_runner "/__version__ / s/= .*/= \"${NEXT_FULL_TAG}\"/g" python/pylibraft/pylibraft/_version.py
sed_runner "/__version__ / s/= .*/= \"${NEXT_FULL_TAG}\"/g" python/raft-dask/raft_dask/_version.py
